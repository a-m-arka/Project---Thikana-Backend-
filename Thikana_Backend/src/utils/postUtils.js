...
export const createPost = async (propertyId, userId, postType) => {
  ...
  try {
    ...
    return {
      success: false,
      message: "Error adding post in database",
      error: error,
    };
  }
};
...
export const checkPropertyPosted = async (propertyId) => {
  ...
  try {
    ...
    return {
      success: false,
      message: "Error checking if property has been posted",
      error: error,
    };
  }
};
...
export const checkPostExists = async (postId) => {
  ...
  try {
    ...
    return {
      success: false,
      message: "Error checking if post exist in database",
      error: error,
    };
  }
};
...
export const getPostUser = async (postId) => {
  ...
  try {
    ...
    return {
      success: false,
      message: "Error fetching user of the post from database",
      error: error,
    };
  }
};
...
export const getPublishedPosts = async () => {
  try {
    const [posts] = await pool.query(postQueries.getPublishedPosts);
